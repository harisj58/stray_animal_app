...
public final class InfoBottomSheetBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView statusDetect;
  ...
  private InfoBottomSheetBinding(@NonNull NestedScrollView rootView,
      ...
      @NonNull TextView statusDetect, @NonNull AppCompatImageButton threadsMinus,
    ...
    this.statusDetect = statusDetect;
  ...
  public static InfoBottomSheetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.status_detect;
      TextView statusDetect = ViewBindings.findChildViewById(rootView, id);
      if (statusDetect == null) {
        break missingId;
      }
      ...
      return new InfoBottomSheetBinding((NestedScrollView) rootView, bottomSheetLayout,
          ...
          spinnerDelegate, spinnerModel, statusDetect, threadsMinus, threadsPlus, threadsValue,
